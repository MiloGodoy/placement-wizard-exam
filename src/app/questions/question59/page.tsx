...
export default function Question59() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "59";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="Why didn’t Rainbow Mountain exist until around 2015?
                "
                options={[
                    "A. It was covered with sand",
                    "B. It was hidden by ice",
                    "C. The area was restricted by the government",
                    "D. It always existed"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question60'>
                    <button
