...
export default function Question74() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "74";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="You are __________ beautiful ________ I can’t keep my eyes off you.
                "
                options={[
                    "A. that / so",
                    "B. such / so",
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question75'>
                    <button
