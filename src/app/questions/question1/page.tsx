...
export default function Question1 () {
    ...
    const handleNextQuestion = () => {
      ...
      const respuesta1 = answers[parseInt(question_number) - 1];
      console.log("respuesta1: ", respuesta1)
        
        if( questionNumberWithAnswer === respuesta1 ){
          store.increaseCorrectAnswers(); // Incrementar el contador de respuestas correctas
  ...
  return (
    <div className="text-center">
      ...
      <Question 
        ...
        question="_____________ do you live?"
        options={[ 
          "A. What",
          "B. Where",
          "C. Who",
