...
export default function Question66() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "66";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="It’s raining and I don’t want to get my suit wet. I _________ better bring an umbrella.
                "
                options={[
                    "A. had",
                    "B. have",
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question67'>
                    <button
