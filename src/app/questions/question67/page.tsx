...
export default function Question67() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "67";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="__________ Alan _________ Janet will help you with your assignment. They are both busy at the moment.
                "
                options={[
                    "A. Nor / nor",
                    "B. Either / or",
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question68'>
                    <button
