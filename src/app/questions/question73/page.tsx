...
export default function Question73() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "73";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="__________ his illness, Frank went to college because he had an important assignment.
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question74'>
                    <button
