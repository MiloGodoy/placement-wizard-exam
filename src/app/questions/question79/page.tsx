...
export default function Question79() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "79";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="According to the text, how can we help the world?
                "
                options={[
                    "A. Changing our habits",
                    "B. Contributing to global warming",
                    "C. Using websites for calculating the carbon footprint",
                    "D. Avoiding certain means of transportation"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question80'>
                    <button
