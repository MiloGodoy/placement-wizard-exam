...
export default function Question43() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "43";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="You __________ a lot _________.
                "
                options={[
                    "A. have been traveling / recently",
                    "B. has been traveling / lately",
                    "C. travel / recently",
                    "D. have traveled / last year"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question44'>
                    <button
