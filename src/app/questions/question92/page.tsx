...
export default function Question92() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "92";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="Our pool pump __________ perfectly before the accident
                "
                options={[
                    "A. had not have run",
                    "B. had been running",
                    "C. hadn’t being running",
                    "D. had not being"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question93'>
                    <button
