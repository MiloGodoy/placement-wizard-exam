...
export default function Question87() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "87";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="I just __________ if you could help me organize the activity. It’s a very tight deadline.
                "
                options={[
                    "A. imagined",
                    "B. wondered",
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question88'>
                    <button
