...
export default function Question55() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "55";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="What is the teacher preparing?"
                options={[
                    "A. dinner",
                    "B. a delicious dessert",
                    "C. a presentation",
                    "D. she is not preparing anything"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question56'>
                    <button
