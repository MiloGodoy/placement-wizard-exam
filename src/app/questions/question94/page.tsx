...
export default function Question94() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "94";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="I would rather __________ my family yesterday than stayed at home doing nothing.
                "
                options={[
                    "A. had visited",
                    "B. have visited",
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question95'>
                    <button
