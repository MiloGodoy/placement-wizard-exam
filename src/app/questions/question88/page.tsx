...
export default function Question88() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "88";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="My mother is Russian __________ my father is Moroccan.
                "
                options={[
                    "A. even though",
                    "B. despite",
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question89'>
                    <button
