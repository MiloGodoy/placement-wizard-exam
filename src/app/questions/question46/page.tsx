...
export default function Question46() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "46";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="He has a headache. He __________ to the doctor twice but is still not better.
                "
                options={[
                    "A. has been",
                    "B. gone",
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question47'>
                    <button
