...
export default function Question83() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "83";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="There’s __________ at me because it’s your own fault that this __________ in your life.
                "
                options={[
                    "A. no point shout / happened",
                    "B. no point to shout / happens",
                    "C. no point to shouted / is happening",
                    "D. no point shouting / has happened"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question84'>
                    <button
