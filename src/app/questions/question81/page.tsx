    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="The best advice is that we should exercise regularly __________ weight.
                "
                options={[
                    "A. in order not to gain",
                    "B. so that not gain",
                    "C. in order to not gain",
                    "D. not gaining"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question82'>
                    <button
