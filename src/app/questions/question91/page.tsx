...
export default function Question91() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "91";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="I went through the document and it __________ more important than it really is.
                "
                options={[
                    "A. seems to be",
                    "B. seem to be",
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question92'>
                    <button
