...
export default function Question48() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "48";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="I __________ hurry up if I don’t want to miss the plane.
                "
                options={[
                    "A. want to",
                    "B. has to",
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question49'>
                    <button
