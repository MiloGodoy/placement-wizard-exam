...
export default function Question68() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "68";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="They __________ gotten in through the window. It’s broken!
                "
                options={[
                    "A. must have",
                    "B. can have",
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question69'>
                    <button
