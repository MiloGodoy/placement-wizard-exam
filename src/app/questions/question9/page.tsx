  ...
  return (
    <div className="text-center">
      ...
      <div className='text-center font-bold text-lg mb-5 mt-5'>
        <h1>Question 9: Choose the correct option to complete the sentence</h1>
      </div>
      
      <Question
        question_number={question_number}
        question="A: Do you _____________ to speak Italian?
          B: I speak Italian ____________."
        options={[ 
          "A. know how / very well",
          "B. know / well",
          "C. how know / very well",
          "D. know how / good"
        ]}
      ...
      />
          ...
          <div className="mt-10 mx-auto">
            <Link href='../../questions/question10'>
              <button
