...
export default function Question89() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "89";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="The plane __________ to be here at 9 o’clock. Why was it so late __________?                
                "
                options={[
                    "A. was supposed / to arrive",
                    "B. supposed / to arrive",
                    "C. supposed / arrived",
                    "D. is supposed / at arriving"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question90'>
                    <button
