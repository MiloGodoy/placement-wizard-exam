...
export default function Question54() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "54";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="The man __________ was speaking to us is very intelligent.
                "
                options={[
                    "A. whose",
                    "B. who",
            ...
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question55'>
                    <button
