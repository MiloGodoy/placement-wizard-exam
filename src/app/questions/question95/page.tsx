...
export default function Question95() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "95";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="Why has technology left the older generation behind?"

                options={[
                    "A. Older generations are slow",
                    "B. Technology is only for the younger generation",
                    "C. The older generation cannot use technology",
                    "D. They are never left behind"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question96'>
                    <button
