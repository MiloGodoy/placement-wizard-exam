...
export default function Question62() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "62";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="The situation was __________ weird _________ we looked at _________ and started laughing.                
                "
                options={[
                    "A. so / that / each other",
                    "B. that / that/ himself",
                    "C. so / that / themselves",
                    "D. such / that / the other"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question63'>
                    <button
