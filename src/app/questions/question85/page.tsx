    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="If he __________ he __________ the exam.
                "
                options={[
                    "A. has been studying / would pass",
                    "B. been studying / would have passed",
                    "C. had studying / would be passing",
                    "D. had studied / would have passed"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question86'>
                    <button
