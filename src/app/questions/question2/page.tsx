...
export default function Question2() {
    ...
    const handleNextQuestion = () => {
        // Aquí puedes realizar acciones adicionales según la respuesta seleccionada
    ...
    return (
        <div className="text-center">
            ...
            <Question 
                ...
                question="I am not hungry. I _____________ want breakfast"
                options={[ 
                "A. don’t",
                "B. doesn’t",
                "C. didn’t",
