...
export default function Question34() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "34";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="When __________ you _______ the course?
                B: Only in November."
                options={[
                    "A. are / going to start",
                    "B. do / going to start",
                    "C. can / going to start",
                    "D. are / going"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question35'>
                    <button
