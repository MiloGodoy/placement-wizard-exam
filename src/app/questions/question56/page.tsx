...
export default function Question56() {
    const [selectedAnswer, setSelectedAnswer] = useState<string | null>(null);
    const question_number = "56";
    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="What is used in the recipe?
                "
                options={[
                    "A. apples, berries and granola",
                    "B. lime, granola and whipped cream",
                    "C. strawberries, raspberries and blueberries",
                    "D. nuts and berries"
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question57'>
                    <button
