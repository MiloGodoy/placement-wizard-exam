    ...
    return (
        <div className="text-center">
            ...
            <Question
                ...
                question="You need to relax __________ solve the problem. __________ you stress __________ it will be.
                "
                options={[
                    "A. in order to / The more / the worse",
                    "B. to / The most / the worst",
                    "C. in order to / The more / the worst",
                    "D. to / The less / the worst "
                ]}
                onOptionSelect={handleOptionSelect}
            />
            <div className="mt-10 mx-auto">
                <Link href='../../questions/question72'>
                    <button
